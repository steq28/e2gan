...
if __name__ == '__main__':
    ...
    # Create 3 dataset
    dataset1 = ImageDataset(source_dir, target_dir_list[0], transform)
    dataset2 = ImageDataset(source_dir, target_dir_list[1], transform)
    dataset3 = ImageDataset(source_dir, target_dir_list[2], transform)
